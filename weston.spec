...
Version  : 14.0.0
Release  : 29
URL      : https://gitlab.freedesktop.org/wayland/weston/-/releases/14.0.0/downloads/weston-14.0.0.tar.xz
Source0  : https://gitlab.freedesktop.org/wayland/weston/-/releases/14.0.0/downloads/weston-14.0.0.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/weston/-/releases/14.0.0/downloads/weston-14.0.0.tar.xz.sig
...
%setup -q -n weston-14.0.0
cd %{_builddir}/weston-14.0.0
pushd ..
cp -a weston-14.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725470194
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libweston-14.so.0.0.0
...
/usr/lib64/libweston-14.so.0.0.0
