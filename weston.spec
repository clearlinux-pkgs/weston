...
Source0  : https://gitlab.freedesktop.org/wayland/weston/-/releases/14.0.1/downloads/weston-14.0.1.tar.xz
Source1  : https://gitlab.freedesktop.org/wayland/weston/-/releases/14.0.1/downloads/weston-14.0.1.tar.xz.sig
...
%setup -q -n weston-14.0.1
cd %{_builddir}/weston-14.0.1
pushd ..
cp -a weston-14.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729542794
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libweston-14.so.0.0.1
...
/usr/lib64/libweston-14.so.0.0.1
